  ...
  void Update() {
    if (needsUpdate) {
      ...
      UpdateMaterialProperties();
        ...
        float distanceOld = distanceFromCamera;
        ...
        outlineWidth = outlineWidthCurrent / (distanceFromCamera / distanceRemoveOffSetMultiplier); //* (distanceFromCamera / distanceRemoveOffSetMultiplier));
        if (outlineWidth < 0.1)
        {
            outlineWidth = 0;
        }
        ...
        if (distanceOld != distanceFromCamera)
        {
            UpdateMaterialProperties();
        }
